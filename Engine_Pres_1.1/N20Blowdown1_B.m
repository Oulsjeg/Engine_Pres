...
function [m_dot, dn, dT, P] = N20Blowdown1_B(n, T, V, m_tank, A_inj, Cd, Pe, nPress, pr_flg)
...
P = (nPress + n(2))*R*T/(V - n(1)*Vhat_l);
a = m_tank*c_P + nPress*CVhat_He + n(2)*CVhat_g + n(1)*CVhat_l;
RT = P*Vhat_l;
e = -delta_Hv + R*T;
